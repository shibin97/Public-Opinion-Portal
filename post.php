        ...
        <div class="row">
            ...
            <div class="col-lg-8">
               ...
               ?>
                ...
                <!-- Comments Form -->
                <div class="well">
                    <h4>Please Share Your Opinion:</h4>
                    <form role="form" method="post" action="">
                       <div class="form-group">
                          <label for="author_name">Name</label>
                           <input name="author_name" type="text" class="form-control" placeholder="Your Name">
                       </div>
                        <div class="form-group">
                          <label for="comment_email">Email Address</label>
                           <input name="comment_email" class="form-control" type="email" placeholder="sample@example.com">
                       </div>
                       
                        <div class="form-group">
                           <label for="comment_content">Comment</label>
                            <textarea class="form-control" rows="15" name="comment_content" placeholder="Blah Blah Blah.."></textarea>
                        </div>
